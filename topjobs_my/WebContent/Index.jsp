...
<link rel="stylesheet" type="text/css" href="Assets/Stylesheet/mainhome.css">
...
<section id="contact" class="contact">
  ...
  <div class="column left" style="background-color:#aaa;">
    <h3 align="center">Recent Jobs</h3>

      <div class="table">
        <table>
          <tbody>
            <tr>
              <td><a href = #>Technical Support Executives</a><p>Data Management Systems(pvt) Ltd</p></td>
            </tr>
            <tr>
              <td><a href = #>Customer Care Executive</a><p>Skin Clinic</p></td>
            </tr>
            <tr>
              <td><a href = #>Junior Executive Treasury</a><p>Ambeon Holding PLC</p></td>
            </tr>
            <tr>
              <td><a href = #>Junior CRM associate (Digital Marketing)</a><p>Daraz.lk</p></td>
            </tr>
            <tr>
              <td><a href = #>CNC Progrmmer</a><p>Elecro Metal Pressing (Pvt) Ltd</p></td>
            </tr>
            <tr>
              <td><a href = #>Data Engineer</a><p>C S Tech Ventures (Pvt) Ltd</p></td>
            </tr>
            <tr>
              <td><a href = #>Technical Support Executives</a><p>Data Management Systems(pvt) Ltd</p></td>
            </tr>
  ...
  <div class="column right">
    <div>
      <h1 align="center">Find Your Dream Job with TOPJOBS</h1>
    </div>
...
<footer id="footer">
  ...
  <a href="Index.jsp" class="back-to-top"><i class="fa fa-arrow-up"></i></a>
